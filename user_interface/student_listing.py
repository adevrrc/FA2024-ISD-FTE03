"""The module defines the StudentListing class."""
...
from demo_superclasses import Listing
from user_interface.grade_point_average_calculator import GradePointAverageCalculator

class StudentListing(Listing):
    """A window which displays student data. Inherited from Listing 
    which provides the gui design.
    """
    def __init__(self):
